      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-indigo-950 via-slate-900 to-slate-900 text-white pt-20 pb-28 px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-5xl mx-auto text-center space-y-8 relative z-10">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-indigo-300 text-xs font-semibold">
            ...
            <span>CoSaPl — Coursework Sales Platform (cosapl.web.app)</span>
          </div>
          ...
          <p className="max-w-2xl mx-auto text-slate-300 text-base sm:text-lg leading-relaxed">
            Minglab tayyor kurs ishlarini namunasi bilan ko'rib xarid qiling yoki mavzuingiz bo'yicha buyurtma bering — <strong className="text-white font-semibold">inson mualliflar jamoasi 24–48 soat ichida bepul reja</strong> tayyorlab beradi.
          </p>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
            ...
            >
              ...
              <span>Antiplagiat & Sertifikat</span>
            </Link>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-4xl mx-auto pt-10 border-t border-slate-800/80 text-center">
            <div className="p-3">
              <span className="block text-2xl sm:text-3xl font-extrabold text-white">5,000+</span>
              <span className="text-xs text-slate-400">Tayyor o'quv ishlari</span>
            </div>
            <div className="p-3">
            ...
            <div className="p-3">
              ...
              <span className="text-xs text-slate-400">Xavfsiz to'lov tizimi</span>
            </div>
            <div className="p-3">
              <span className="block text-2xl sm:text-3xl font-extrabold text-amber-400">QR-kodli</span>
              <span className="text-xs text-slate-400">Rasmiy sertifikatlar</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm hover:shadow-lg transition-all space-y-4 relative overflow-hidden group">
            ...
            <h3 className="text-xl font-bold text-slate-900">3. Antiplagiat & Sertifikat</h3>
            <p className="text-slate-600 text-sm leading-relaxed">
              O'quv ishingizni alohida to'lov asosida professional antiplagiat tizimlarida tekshirtiring. Natijada QR-kodli rasmiy sertifikat va to'liq PDF tahliliy hisobot oling.
            </p>
            <Link
              href="/antiplagiat"
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between mb-8 gap-4">
          <div>
            ...
            <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-1">
              Eng ko'p yuklab olingan kurs ishlari
            </h2>
          </div>
          <Link
            href="/katalog"
          ...
          >
            <span>Barcha ishlarni ko'rish ({works.length})</span>
            <ArrowRight className="w-4 h-4" />
          </Link>
        </div>
